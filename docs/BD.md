...
| **5\. Исторический снапшот (Конец сезона):** | **Обновление карьерной статистики.** | Player\_Club\_Career\_Stats | В конце сезона взять итоговые данные из Player\_Season\_Stats и **добавить** их к общему счету игрока в этом клубе. |
