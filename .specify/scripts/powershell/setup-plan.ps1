#!/usr/bin/env pwsh
# Настройка плана реализации для функции
...
# Проверить, что мы находимся на правильной ветке функции (только для git репозиториев)
...
# Скопировать шаблон плана, если он существует, иначе создать пустой файл
...
if (Test-Path $template) { 
    ...
    # Создать базовый файл плана, если шаблона нет
